...
const ConversationScreen = () => {
    ...
    }, [ dispatch, chat, chatId, matchId, messageList])
    ...
    useEffect(() => {
        loadCheckReport();
        loadCheckBlock();
    }, [receiver, authUser, chat, chatId, matchId])
    ...
    useEffect(() => {
        if(stompClient == null && chat && !isblocked) {
          connect();
        }
  ...
  return (
    <SafeAreaView style={tw('flex-1')}>
        ...
        <Modal animationType='slide' visible={visible} transparent={true}>
            <View style={[tw(' bg-zinc-200 rounded-2xl items-center justify-center flex px-4'), {height: "25%", top: "75%",  width: "100%"}, styles.shadow]}>  
                ...
                <TouchableOpacity onPress={() => setVisible(false)} style={[tw('mx-auto px-4 rounded-full my-2 bg-green-500 mx-auto py-2'), {width: 120}]}>
